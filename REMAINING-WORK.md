...
- **B2B block at the END of the Shop + Home CTA (brief §04) — PARKED by project decision 2026-08-06.** Today only a top-of-shop B2B button routing to the contact form ("professional" topic) exists. **B2B button redesigned 2026-08-28:** replaced the busy lime/gold aurora animation and dashed borders with a refined premium gold-frame design — clean 1.5px gold border with subtle gradient background, corner ornament details (like jewelry), elegant multi-layered shadows that intensify on hover, subtle 1px lift animation, and the arrow positioned absolutely on the right. Design follows Nostrum's "premium = restraint" principle: eye-catching but refined, distinctive without being overwhelming, maintaining the quiet luxury aesthetic. Verified clean with `npm run build`.
